    ...
    public void onCreate() {
        ...
        RealmConfiguration config =
                new RealmConfiguration.Builder()
                        //below line is to allow write data to database on ui thread.
                        .allowWritesOnUiThread(true)
                        //below line is to delete realm if migration is needed.
                        .deleteRealmIfMigrationNeeded()
                        //at last we are calling a method to build.
                        .build();
        //on below line we are setting configuration to our realm database.
